...
class LineOperationsControllerTests {
    ...
    void shouldExposeTheOperationalSummaryWithStationsAndLiveTrains() throws Exception {
        ...
        mockMvc.perform(get("/api/lines/operations"))
                ...
                .andExpect(jsonPath("$.lines[0].currentPeriodType").value("PEAK"))
                ...
                .andExpect(jsonPath("$.lines[0].depots[0].dispatchEnabled").value(true))
                .andExpect(jsonPath("$.lines[0].depots[0].receptionEnabled").value(true))
                ...
                .andExpect(jsonPath("$.lines[0].nextArrivals[0].destinationStationCode").value("ST002"))
                .andExpect(jsonPath("$.lines[0].nextArrivals[0].stationsAway").value(1))
